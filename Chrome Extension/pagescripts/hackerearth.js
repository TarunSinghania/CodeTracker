$(function(){
	...
	$('.second-level-menu-list').append('<select id ="da" class="js-example-basic-multiple" name="states[]" multiple="m5ltiple"><option value="dp">DP</option><option value="graph">Graphs</option><option value="Segment trees">Segment Trees</option></select>');*/
    $('#problem-title').append('<div class="code_tracker_style" style="display:inline-block;min-height:70px;position:relative;z-index:10000;margin-left:20px;"></div>');
